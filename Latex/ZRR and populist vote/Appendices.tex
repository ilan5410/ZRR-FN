...
\begin{figure}
    ...
    \includegraphics[width=1\linewidth]{figures/distanceMapAndDistribution_epi.png}
...
\caption{RDD: balancing checks with alternative distance measure}
    ...
    \begin{subfigure}{1\textwidth}
        \includegraphics[width=\linewidth]{figures/RDD_plots_conditional_part1_noEpi.png}
...
\begin{figure}\ContinuedFloat
    \begin{subfigure}{1\textwidth}
        \includegraphics[width=\linewidth]{figures/RDD_plots_conditional_part2_noEpi.png}
...
\begin{figure}
    ...
    \includegraphics[width=1\linewidth]{figures/RDD_plots_conditional_FN1988_noEpi.png}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.95\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/RDD_plots_conditional_outcomes_20000_noEpi.png}
    ...
    \begin{subfigure}[b]{0.95\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/RDD_plots_conditional_outcomes_10000_noEpi.png}
...
\begin{figure}[htbp]
    ...
    \centering
        \includegraphics[width=\linewidth, height=0.5\textwidth]{figures/RDD_plots_conditional_outcomes1995.png}
