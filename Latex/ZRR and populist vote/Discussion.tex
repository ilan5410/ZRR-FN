...
Table \ref{tab:tab:effect_1999} shows no significant effect of the ZRR program on the 1999 socioeconomic variables. The slight increase in population is most certainly due to the gap I observed earlier between the two groups of comparison. %Table X shows that the change in population size between 1990 and 1999 is not affected by the program.
...
The results displayed in Table \ref{tab:absolute-vote} indicate a negative and statistically significant effect of the program on the log of the absolute number of votes for the FN (the numerator): $-$4.3\% at the 20 km bandwidth and $-$3.3\% at the 10 km bandwidth. The estimate loses significance and shrinks toward zero at the 5 km bandwidth, where the sample is smallest and the estimates are the least precise. Earlier, I found no precise effect of the program on turnout (Table \ref{tab:rdd_results_outcomes_later}). Taken together, these results suggest that the negative effect of the program on the FN vote share operates through the numerator: the program reduced the absolute number of FN votes, rather than diluting the FN share by mobilizing "new" voters into the electorate. I conclude that the effect of the program reflects diminished support for the FN.
