...
% NOTE (removed per IP's note: "this subsection is redundant with what comes before — the lit
% survey on the determinants of populist voting is already in the introduction").
% The original "Determinants of populist voting" subsubsection is preserved below in comments.
%
...
\textit{\textbf{Eligibility to the program}} - The ZRR program was implemented in September 1996 under the 1995 law and targeted rural employment. Initial eligibility was determined using demographic, economic, and institutional criteria at the canton level. A canton had to have population density below 31 inhabitants per square kilometer in the 1990 Census and either population or labor-force decline between the 1982 and 1990 censuses, or an agricultural-employment share at least twice the national average. The relevant communes also had to belong to the Territoire Rural de Développement Prioritaire (TRDP) zoning scheme. Political considerations may have affected selection beyond these criteria (\cite{Gobillon}); this is a central limitation of the empirical design. For a description of the program, see \cite{BEHAGHEL20151}.

In 2005, additional cantons entered under updated eligibility criteria based on the 1999 census, while already designated cantons were not withdrawn. The later wave required population density below 31 inhabitants per square kilometer under the 1999 census and introduced an inter-communal establishment (EPCI) condition in place of the earlier TRDP reference. The 1990 criteria therefore govern the initial wave and the 1999 criteria the later wave; they were not jointly applied to every canton.
...
\parbox{\textwidth}{\footnotesize \textit{Notes:} Treatment status is determined at the canton level. Black cantons belong to the initial ZRR wave, coded in 1995 although implementation began in 1996. Dark-gray cantons are later entrants from the 2005 extension; light-gray cantons are never treated.}
...
\textit{\textbf{Size of the program}} - The program covered about 39\% of French territory but around 8\% of the population. Published cost estimates are not directly comparable across phases because they cover different exemptions and beneficiary groups: Lorenceau (2009) reports an order of magnitude around 100 million euros before 2005, whereas later figures around 400 million euros cover a broader regime. In 2008, \cite{BEHAGHEL20151} report 200 million euros of payroll-tax exemptions for public-interest organizations and 38 million euros for other ZRR firms. These figures describe the scale of the policy, not a consistent annual cost series.

\textbf{\textit{Timing of the program}} - The program was voted on in February 1995 but was not launched until September 1996. The 1995 presidential elections took place in April, and the legislation may have already affected the results, particularly if the signaling effect was dominant. As a baseline, we take the 1988 elections to be the last pre-treatment election.\footnote{In section \ref{app:1995signal}, we report results relative to the 1995 elections.}
