...
\begin{figure}
    \centering
    \caption{TODO: remove double title. Nonparametric Effect of several Locality Characteristics, as of 2002 on Support for FN over Time}
...
\begin{figure}
    \centering
    \caption{TODO: remove double title.Population size and FN voting}
