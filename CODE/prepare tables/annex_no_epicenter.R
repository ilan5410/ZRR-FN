# ================================================================================
# TABLE Annex — MAIN RESULTS (Different Bandwidths) shortest distance
# ================================================================================
...
build_main_results_by_bandwidth <- function(processed_data_path,
  ...
  df_rdd <- df_rdd %>% 
    filter(!if_any(dplyr::all_of(c(outcome, cluster_var, "z", "x_km10")), is.na))
  ...
  out_path <- file.path(path_tables, "annex_no_epicenter.tex")
