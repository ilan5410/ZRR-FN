...
# Using different distance definition.
# ==============================================================================
...
process_sharp_rdd_data <- function(processed_data_path, treatment_year = 1995, control_year = 1990) {
  ...
  save(dfDistance, dfZRRControls, file = file.path(processed_data_path, "script_sharp_noEpicenter.RData"))
  
  cat("✓ Saved script_sharp_noEpicenter.RData\n")
  cat("\n=============================================================\n")
  cat("SHARP RDD (shortest distance) PROCESSING COMPLETED SUCCESSFULLY\n")
  cat("===============================================================\n")
